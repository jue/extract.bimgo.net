...
var config ={
	credentials: {
		...
		client_id: process.env.FORGE_CLIENT_ID || 'wsnogMLuZOWJfQEP6iJt5BZzGVYGYuAo',
		client_secret: process.env.FORGE_CLIENT_SECRET || 'qrqp22gTRF24AqXF',
	...
	mailTo: '',
	domain: process.env.NODE_ENV === 'production' ? 'https://extract.bimgosoft.com/' : 'https://pzzpaj-8080-evggwh.dev.ide.live/',
